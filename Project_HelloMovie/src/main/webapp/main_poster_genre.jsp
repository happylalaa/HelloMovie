				...
				<article class="col-md-4 col-sm-6 col-xs-12 clearfix wow fadeInUp" data-wow-duration="500ms" style="width: 100%;">
					<div class="post-block" style="display: flex;">
						<div class="genre" style="background-color: #353b43; flex: 1;" align="center">
								<a href="Hello/movie/movie_select_genre.jsp?genre=action">
						...
						<div class="genre" style="background-color: #353b43; flex: 1;" align="center">
								<a href="Hello/movie/movie_select_genre.jsp?genre=horror">
						...
						<div class="genre" style="background-color: #353b43; flex: 1;" align="center">
								<a href="Hello/movie/movie_select_genre.jsp?genre=SF">
						...
						<div class="genre" style="background-color: #353b43; flex: 1;" align="center">
								<a href="Hello/movie/movie_select_genre.jsp?genre=romantic">
						...
						<div class="genre" style="background-color: #353b43; flex: 1;" align="center">
								<a href="Hello/movie/movie_select_genre.jsp?genre=animation">
