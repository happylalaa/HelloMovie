 ...
 <!-- 
  ...
  ==================================== -->
    <header id="navigation" class="navbar navigation">
        <div class="container" style="padding: 0; margin: 0% 10%;">
        ...
        <nav class="collapse navbar-collapse navbar-right" role="Navigation" style="width: 80%;">
        	...
        	<form action="Hello/movie/movie_select_search_list.jsp" method="post">
        	
					<ul id="nav" class="nav navbar-nav navigation-menu" style="width:100%; ">
						<li style="padding:15px; width: 15%;">
						...
						<li>
							<a>
								<input type="text" name="searchWord" placeholder="검색어를 입력하세요" size="50%" 
									style="border-radius: 5px; height: 35px; margin: 0px; border: #57cbcc 1px solid;">
							</a>
						</li>
						<li>
							<a>
            ...
            <li id="movie_menu"><a href="#">영화</a>
            	<ul>
            		<li align="center"><a href="Hello/movie/movie_select_popular.jsp">인기영화</a></li>
            		<li align="center"><a href="Hello/movie/movie_select_new.jsp">최신영화</a></li>
            		<li align="center"><a href="Hello/movie/movie_select_genre.jsp">장르별영화</a></li>
            		<li align="center"><a href="Hello/movie/movie_select_age.jsp">연령별영화</a></li>
            	</ul>
            </li>
            ...
            %>
             <li id="movie_menu"><a href="#">마이페이지</a>
             	<ul>
             		...
             		<li align="center"><a href="Hello/bucket/bucket.jsp">찜한영화목록</a></li>
             		<li align="center"><a href="/Hello/movie/movie_review.jsp">내가 작성한 리뷰</a></li>
         		 <%
             		if(result==1)	{
             %>
             ...
             %>
             		<li align="center"><a href="Hello/member/member_detail.jsp">회원정보</a></li>
             
             <%
             		if(result==1)	{
             %>
             		<li align="center"><a href="Hello/member/admin_member_list.jsp">회원관리</a></li>
             		<li align="center"><a href="Hello/movie/manager_movie_select.jsp">영화관리</a></li>
             	<%
             		}
             	%>
             	</ul> 
