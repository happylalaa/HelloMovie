...
<%
	...
	String keyword = request.getParameter("keyword"); // 받는 값 : 검색할 컬럼(value값) 
	String searchWord = request.getParameter("searchWord"); 
	 
	Vector<MovieVO> vv = new Vector<MovieVO>(); // 벡터반환 
	vv = mdao.searchMovie(keyword,searchWord);
	// 벡터저장값 출력
	%>
		...
		<div class="container">
			...
			<!-- section title -->
				<div class="title text-center wow fadeIn" data-wow-duration="500ms">
					<h2>영화 <span class="color">조회</span></h2>
						...
						<div class="media_hover">
							<div class="media-wrapper">
								<a href="movie_detail.jsp?movie_code=<%=mvvo.getMovie_code() %>">
									<img src="images/<%=mvvo.getMovie_img() %>" class="img-responsive" style="width: 100%; height: 500px;">
								</a>
							</div>
							<div class="content" style="background-color: #292f36; padding: 0; height: 100px;">
							<br>
								<h3 align="center">
									<a href="movie_detail.jsp?movie_code=<%=mvvo.getMovie_code() %>">
										<%=mvvo.getMovie_title()%>
